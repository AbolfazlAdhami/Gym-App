...
const ExerciseCard = ({ exercise }) => {
  ...
  return (
    <Box className="exercise-card" onClick={() => navigate(`/exerciseDetails/${exercise.id}`)} sx={{ cursor: "pointer", boxShadow: "rgba(0, 0, 0, 0.24) 0px 3px 8px", borderRadius: " 0 0 2rem 2rem" }}>
